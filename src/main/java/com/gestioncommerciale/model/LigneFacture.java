...
/**
 * Entity representing a line item in a Facture (Invoice Line)
 */
@Entity
...
public class LigneFacture {
    ...
    public LigneFacture(Facture facture, Article article, BigDecimal quantite, BigDecimal prixUnitaire) {
